...
Insignficant and Not deprecated
Use YOLOv3 Approach instead
"""
...
path = r'D:\Python\Smart_Traffic\Test Data\edmonton_canada.mp4'
...
while cap.isOpened():
    ...
    blob_scale = 0.007
    blob_mean = 127
    blob = cv2.dnn.blobFromImage(image, blob_scale, (300, 300), blob_mean)
